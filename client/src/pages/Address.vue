<template>
  <div>
          ...
          <div class="addr-list-wrap">
            <div class="addr-list">
              <ul>
                ...
                <li class="addr-new" @click="addAddressConfirm">
    ...
    <modal :mdShow="isMdShowAdd" @close="closeModal">
      <ul slot="message">
        <li>
          <label>
      ...
      <div slot="btnGroup">
          ...
          <a class="btn btn--m btn--red" href="javascript:;" @click="isMdShowAdd=false">取消</a>
      </div>
    </modal>
  </div>
</template>
